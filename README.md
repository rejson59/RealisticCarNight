...
npm test           # testy headless (miasto, fizyka, autopilot, AI, pierścienie…)
...
- **Post-processing**: bloom (neony!), ACES filmic tone mapping, winieta, aberracja chromatyczna, radialny blur prędkości, drobne ziarno filmu.
...
src/
  ...
  render/PostFX.js        # composer: bloom, winieta, CA, blur prędkości, ziarno, tryb foto
...
test/headless.mjs         # testy bez WebGL: miasto, fizyka, AI, światła, pierścienie
```
